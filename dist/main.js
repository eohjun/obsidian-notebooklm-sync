...
${e}`;let n=await this.webview.executeJavaScript(`
    ...
    `);if(!i?.success)throw new Error(i?.error||"\uD14D\uC2A4\uD2B8 \uBD99\uC5EC\uB123\uAE30 \uC635\uC158\uC744 \uCC3E\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4");if(await this.plugin.delay(1e3),!(await this.webview.executeJavaScript(`
      (function() {
